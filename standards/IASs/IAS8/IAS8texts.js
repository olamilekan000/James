...
(i) - the requirements and guidance in IASB standards and interpretations dealing with similar and related issues; and
(ii) - the definitions, recognition criteria and measurement concepts for assets, liabilities, income and expenses in the Framework. [IAS 8.11]
...
`,
discRelatedToANewStndAcctngPolicies:`
...
(iv) - for the current period and each prior period presented, to the extent practicable, the amount of the adjustment:
...
`,
discRelatedToVoluntaryAcctngPolicies:`
...
(iii) - for the current period and each prior period presented, to the extent practicable, the amount of the adjustment:
	* for each financial statement line item affected, and
	* for basic and diluted earnings per share (only if the entity is applying IAS 33).
(iv) - the amount of the adjustment relating to periods before those presented, to the extent practicable.
(v) - if retrospective application is impracticable, an explanation and description of how the change in accounting policy was applied.
...
(ii) - for each prior period presented, to the extent practicable, the amount of the correction:
	* for each financial statement line item affected, and
	* for basic and diluted earnings per share (only if the entity is applying IAS 33).
(iii) - the amount of the correction at the beginning of the earliest prior period presented.
(iv) - if retrospective restatement is impracticable, an explanation and description of how the error has been corrected.
