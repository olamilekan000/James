...
(a) - It is inherent in the recognition of an asset or liability that that asset or liability will be recovered or settled, and this recovery or settlement may give rise to future tax consequences which should be recognised at the same time as the asset or liability
(b) - An entity should account for the tax consequences of transactions and other events in the same way it accounts for the transactions or other events themselves.
...
(i) Temporary difference = Carrying amount	 - 	Tax base.
(ii) Deferred tax asset or liability = 	Temporary difference x Tax rate.
...
(ii) - Revenue received in advance: The tax base of the recognised liability is its carrying amount, less revenue that will not be taxable in future periods [IAS 12.8]

(iii) - Other liabilities: The tax base of a liability is its carrying amount, less any amount that will be deductible for tax purposes in respect of that liability in future periods [IAS 12.8].

(iv) - Unrecognised items: If items have a tax base but are not recognised in the statement of financial position, the carrying amount is nil [IAS 12.9].

(v) - Tax bases not immediately apparent. If the tax base of an item is not immediately apparent, the tax base should effectively be determined in such as manner to ensure the future tax consequences of recovery or settlement of the item is recognised as a deferred tax amount [IAS 12.10].

(vi) - Consolidated financial statements. In consolidated financial statements, the carrying amounts in the consolidated financial statements are used, and the tax bases determined by reference to any consolidated tax return (or otherwise from the tax returns of each entity in the group). [IAS 12.11]

`,
exceptionsTOrecogOfDefTaxLiab:`
...
(a) - liabilities arising from initial recognition of goodwill [IAS 12.15(a)]
(b) - liabilities arising from the initial recognition of an asset/liability other than in a business combination which, at the time of the transaction, does not affect either the accounting or the taxable profit [IAS 12.15(b)]
(c) - liabilities arising from temporary differences associated with investments in subsidiaries, branches, and associates, and interests in joint arrangements, but only to the extent that the entity is able to control the timing of the reversal of the differences and it is probable that the reversal will not occur in the foreseeable future. [IAS 12.39]
...
(i) - the initial recognition of an asset or liability other than in a business combination which, at the time of the transaction, does not affect accounting profit or taxable profit.
...
`,
guidance_on_measuring_deferred_taxes:`
(i) - Where the tax rate or tax base is impacted by the manner in which the entity recovers its assets or settles its liabilities (e.g. whether an asset is sold or used), the measurement of deferred taxes is consistent with the way in which an asset is recovered or liability settled [IAS 12.51A]

(ii) - Where deferred taxes arise from revalued non-depreciable assets (e.g. revalued land), deferred taxes reflect the tax consequences of selling the asset [IAS 12.51B]

(iii) - Deferred taxes arising from investment property measured at fair value under IAS 40 Investment Property reflect the rebuttable presumption that the investment property will be recovered through sale [IAS 12.51C-51D]

(iv) - If dividends are paid to shareholders, and this causes income taxes to be payable at a higher or lower rate, or the entity pays additional taxes or receives a refund, deferred taxes are measured using the tax rate applicable to undistributed profits [IAS 12.52A]

(v) - Where it is difficult to determine the amount of current and deferred tax relating to items recognised outside of profit or loss (e.g. where there are graduated rates or tax), the amount of income tax recognised outside of profit or loss is determined on a reasonable pro-rata allocation, or using another more appropriate method [IAS 12.63]

(vi) - In the circumstances where the payment of dividends impacts the tax rate or results in taxable amounts or refunds, the income tax consequences of dividends are considered to be more directly linked to past transactions or events and so are recognised in profit or loss unless the past transactions or events were recognised outside of profit or loss [IAS 12.52B]

(vii) - The impact of business combinations on the recognition of pre-combination deferred tax assets are not included in the determination of goodwill as part of the business combination, but are separately recognised [IAS 12.68]

(viii) - The recognition of acquired deferred tax benefits subsequent to a business combination are treated as 'measurement period' adjustments (see IFRS 3 Business Combinations) if they qualify for that treatment, or otherwise are recognised in profit or loss [IAS 12.68]

(ix) - Tax benefits of equity settled share based payment transactions that exceed the tax effected cumulative remuneration expense are considered to relate to an equity item and are recognised directly in equity. [IAS 12.68C]
...
(i) - transactions or events that are recognised outside of profit or loss (other comprehensive income or equity) - in which case the related tax amount is also recognised outside of profit or loss [IAS 12.61A]
(ii) - a business combination - in which case the tax amounts are recognised as identifiable assets or liabilities at the acquisition date, and accordingly effectively taken into account in the determination of goodwill when applying IFRS 3 Business Combinations. [IAS 12.66]
...
(iii) - amount of deferred tax expense (income) relating to the origination and reversal of temporary differences 
(iv) - amount of deferred tax expense (income) relating to changes in tax rates or the imposition of new taxes 
(v) - amount of the benefit arising from a previously unrecognised tax loss, tax credit or temporary difference of a prior period write down, or reversal of a previous 
(iv) - write down, of a deferred tax asset 
(v) - amount of tax expense (income) relating to changes in accounting policies and corrections of errors.

IAS 12.81 requires the following disclosures:

(i) - aggregate current and deferred 
(ii) - tax relating to items recognised directly in equity tax relating to each component of other comprehensive income 
(iii) - explanation of the relationship between tax expense (income) and the tax that would be expected by applying the current tax rate to accounting profit or loss (this can be presented as a reconciliation of amounts of tax or a reconciliation of the rate of tax) 
(iv) - changes in tax rates 
(v) - amounts and other details of deductible 
(vi) - temporary differences, unused tax losses, and unused tax credits temporary differences associated with investments in subsidiaries, branches and associates, and interests in joint arrangements 
(vii) - for each type of temporary difference and unused tax loss and credit, the amount of deferred tax assets or liabilities recognised in the statement of financial position and the amount of deferred tax income or expense recognised in profit or loss 
(viii) - tax relating to discontinued operations 
(ix) - tax consequences of dividends declared after the end of the reporting period 
(x) - information about the impacts of business combinations on an acquirer's deferred tax assets 
(ix) - recognition of deferred tax assets of an acquiree after the acquisition date.

Other required disclosures:

(i) - details of deferred tax assets [IAS 12.82] 
(ii) - tax consequences of future dividend payments. [IAS 12.82A]
...
(i) - Disclosure on the face of the statement of financial position about current tax assets, current tax liabilities, deferred tax assets, and deferred tax liabilities [IAS 1.54(n) and (o)]
(ii) - Disclosure of tax expense (tax income) in the profit or loss section of the statement of profit or loss and other comprehensive income (or separate statement if presented). [IAS 1.82(d)]
`
