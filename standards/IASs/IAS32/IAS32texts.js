...
(a) - clarifying the classification of a financial instrument issued by an entity as a liability or as equity 
(b) - prescribing the accounting for treasury shares (an entity's own repurchased shares) 
(c) - prescribing strict conditions under which assets and liabilities may be offset in the balance sheet
...
(b) - employers' rights and obligations under employee benefit plans (see IAS 19 Employee Benefits) 
(c) - insurance contracts(see IFRS 4 Insurance Contracts). However, IAS 32 applies to derivatives that are embedded in insurance contracts if they are required to be accounted separately by IAS 39
(d) - financial instruments that are within the scope of IFRS 4 because they contain a discretionary participation feature are only exempt from applying paragraphs 15-32 and AG25-35 (analysing debt and equity components) but are subject to all other IAS 32 requirements 
(e) - contracts and obligations under share-based payment transactions (see IFRS 2 Share-based Payment) with the following exceptions:
	(i) - this standard applies to contracts within the scope of IAS 32.8-10 
	(ii) - paragraphs 33-34 apply when accounting for treasury shares purchased, sold, issued or cancelled by employee share option plans or similar arrangements
...
`,
FinInstrument:`
It is contract that gives rise to a financial asset of one entity and a financial liability or equity instrument of another entity.
`,
FinAsset:`
any asset that is:
(a) - cash
...
(d) - a contract that will or may be settled in the entity's own equity instruments and is:
	...
	(iii) - puttable instruments classified as equity or certain liabilities arising on liquidation classified by IAS 32 as equity instruments
`,
finLiab:`
...
(a) - a non-derivative that includes no contractual obligation for the issuer to deliver a variable number of its own equity instruments; or
(b) - a derivative that will be settled only by the issuer exchanging a fixed amount of cash or another financial asset for a fixed number of its own equity instruments. [IAS 32.16]

`,
contigentSettlmntProv:`
...
(i) - the contingent settlement provision is not genuine or 
(ii) - the issuer can only be required to settle the obligation in the event of the issuer's liquidation or 
(iii) - the instrument has all the features and meets the conditions of IAS 32.16A and 16B for puttable instruments [IAS 32.25]
...
(i) - has a legally enforceable right to set off the amounts; and 
(ii) - intends either to settle on a net basis, or to realise the asset and settle the liability simultaneously. [IAS 32.48]
`,
TheCostOfissuigEquityInstr:`
