...
(a) - at cost, or 
(b) - in accordance with IFRS 9 Financial Instruments (or IAS 39 Financial Instruments: Recognition and Measurement for entities that have not yet adopted IFRS 9), or 
(c) - using the equity method as decribed in IAS 28 Investments in Associates and Joint Ventures. [See the amendment information below.]
...
(a) - apply to the establishment of an intermediate parent within a group, as well as establishment of a new ultimate parent of a group [IAS 27(2011).BC24] 
(b) - apply to an entity that is not a parent entity and establishes a parent in a manner that satisfies the above criteria [IAS 27(2011).14] 
(c) - apply only where the criteria above are satisfied and do not apply to other types of reorganisations or for common control transactions more broadly. [IAS 27(2011).BC27].
...
(b) - a list of significant investments in subsidiaries, jointly controlled entities, and associates, including the name, principal place of business (and country of incorporation if different), proportion of ownership interest and, if different, proportion of voting rights, and
(c) - a description of the method used to account for the foregoing investments.
...
(iv) - IAS 28 Investments in Associates and Joint Ventures (as amended in 2011).
